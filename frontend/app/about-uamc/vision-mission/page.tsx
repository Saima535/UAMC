...
function PlaceholderImage({
  ...
  return (
    <div className={`relative overflow-hidden ${className ?? ""}`}>
      <Image src="/Vision & Mission/camp2.jpg" alt={label} fill sizes="100vw" className="object-cover" />
    </div>
  );
}
      ...
      <main>
        ...
        <section className="bg-[#eaf5e8] py-16">
          <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
            ...
            <div className="mt-10">
              <PlaceholderImage label="Vision Featured Building Photo" className="h-[300px] w-full" />
            </div>
          </div>
        </section>
