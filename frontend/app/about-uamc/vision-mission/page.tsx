...
const aboutLinks = [
  ...
  { href: "/about-uamc/vision-mission", label: "Vision & Mission", active: true },
  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-full w-full flex-col items-center justify-center px-4 text-center">
        ...
        <p className="mt-2 max-w-[220px] text-[11px] leading-5 text-[#5f7466]">Add file to `/public/Vision & Mission/{filename}`</p>
      </div>
    </div>
  );
}
      ...
      <main>
              ...
              <div className="relative flex min-h-[220px] items-end justify-between px-6 pb-8 pt-10 sm:px-10 lg:px-12">
                <div>
                  <p className="text-[13px] font-semibold uppercase tracking-[0.04em] text-[#234237]">
                    Home &gt; About UAMC &gt; <span className="text-[#129547]">Vision &amp; Mission</span>
                  </p>
                ...
                <div className="relative hidden h-[136px] w-[136px] shrink-0 lg:block">
                  <PlaceholderImage label="UAMC Seal" filename="vision-seal.jpg" className="h-full w-full rounded-full border-0" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-[#eaf5e8] py-16">
          <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
            <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
              ...
              <div className="max-w-[650px] pt-2">
                <p className="text-[14px] leading-6 text-[#666]">
                  To be a leading center of excellence in medical education, healthcare, and research, producing skilled,
                  compassionate, and ethical medical professionals who contribute to national and global healthcare
                  advancements.
                </p>
              </div>
            </div>
            ...
            <div className="mt-10">
              <PlaceholderImage label="Vision Featured Building Photo" filename="vision-building.jpg" className="h-[300px] w-full" />
            </div>
          </div>
        </section>

        <section className="relative overflow-hidden py-12">
          <PlaceholderImage label="Admission Banner Background" filename="vision-admission-banner.jpg" className="absolute inset-0" />
