        ...
        <section className="relative overflow-hidden border border-[#d9e3d9] bg-[#dfeae0]">
          ...
          <div className="relative px-5 py-6 sm:px-7 lg:px-8 lg:py-7">
            <div className="text-[11px] font-semibold uppercase tracking-[0.25em] text-[#183123]">
              Home <span className="px-2 text-[#4f6855]">&gt;</span> About UAMC <span className="px-2 text-[#4f6855]">&gt;</span> GB Members
            </div>
          ...
          <div className="mx-auto max-w-[760px]">
            {members.map((member, index) => (
              <article
                ...
                className="overflow-hidden border border-[#d8e1d8] bg-[#dfeae0] p-0 shadow-[0_4px_10px_rgba(0,0,0,0.04)]"
              >
                <div className="w-[420px] max-w-full overflow-hidden border border-[#cfe0d2] bg-[#dfeae0] p-0 shadow-sm">
                  <div className="relative h-[360px] overflow-hidden bg-[#dfeae0]">
                    <Image
                      src={member.image}
                      alt={member.name}
                      fill
                  ...
                  <div className="bg-[#dfeae0] px-4 pb-5 pt-4 text-left">
                    <p className="text-[17px] font-medium leading-6 text-[#1f2b26]">{member.name}</p>
                    <p className="mt-2 text-[13px] leading-6 text-[#34413c]">{member.title}</p>
                  </div>
                </div>
              </article>
            ))}
