...
const admissionForms = [
  {
    no: "01",
    date: "June 22, 2022",
    title: "Application Form for MBBS Admission (Poor & Meritorious Quota)"
  },
  {
    no: "02",
    date: "June 5, 2021",
    title: "General Application Form for MBBS Admission"
  }
];
        ...
        <section className="overflow-hidden border border-[#dfeae0] bg-[#dfeae0]">
          <div className="relative px-5 py-6 sm:px-7 lg:px-8 lg:py-7">
            <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#1d3428]">
              HOME <span className="px-2 text-[#4f6754]">&gt;</span> <span className="text-[#1a7d4f]">FACILITIES</span> <span className="px-2 text-[#4f6754]">&gt;&gt;</span> <span className="text-[#1a7d4f]">Application Form</span>
            </div>
          ...
          {tabs.map((tab) => (
            <Link
              ...
              className={`inline-flex items-center justify-center whitespace-nowrap rounded-md px-5 py-3 text-[11px] font-semibold uppercase tracking-[0.04em] ${
                tab.href === "/admission/forms" ? "bg-[#1a7d4f] text-white" : "bg-[#4a514d] text-white/90"
              }`}
            >
              {tab.label}
            </Link>
        ...
        <section className="mt-8 bg-white px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 overflow-hidden rounded-[8px] border border-[#dfeae0] bg-[#edf5ef]">
            <div className="relative h-[100px] w-full">
              <Image
                src="/Admission Forms/placeholder-hero.svg"
          ...
          <div className="text-center">
            ...
            <p className="mt-3 text-[15px] font-medium text-[#2b3c32]">MBBS Admission Forms</p>
          </div>

          {/* Recent Admission Notices Section */}
          <div className="mt-8 border-l-[4px] border-[#1a7d4f] pl-4">
            <h3 className="text-[18px] font-semibold text-[#1b1b1b]">Recent Admission Notices &amp; Required Documents</h3>
              ...
              <table className="min-w-[900px] w-full border-collapse border border-[#d9e6dc] text-left text-[13px]">
                ...
                <tbody>
                  {admissionForms.map((form) => (
                    <tr key={form.no} className="bg-white text-[#4b5952]">
                      <td className="border border-[#d9e6dc] px-3 py-4 align-top">{form.no}</td>
                      <td className="border border-[#d9e6dc] px-3 py-4 align-top">{form.date}</td>
                      <td className="border border-[#d9e6dc] px-3 py-4 align-top text-[#2d4339]">{form.title}</td>
          ...
          <div className="mt-8 border-l-[4px] border-[#1a7d4f] bg-[#edf5ef] px-4 py-3 text-[14px] leading-7 text-[#2b4339]">
            <span className="font-semibold">Note:</span> Applicants are advised to fill out the appropriate form as per their eligibility criteria and submit it along with required documents to the college office within the notified deadlines.
          </div>
        </section>
      </main>
